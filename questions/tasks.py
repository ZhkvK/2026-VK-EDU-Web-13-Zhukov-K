...
@app.task()
def send_email_task(question):
    send_mail(
        "Notification",
        f"New answer to your question \"{question.content}\" as published!.",
        "from@example.com",
...
@app.task()
def update_user_activity_task(profile):
    profile.update_activity()
    
@app.task()
def update_answer_count_task(question):
