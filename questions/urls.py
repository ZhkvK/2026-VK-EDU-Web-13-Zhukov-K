...
from questions.views import AddCommentView, AnswerVoteView, CorrectAnswerCheckView, ListNewQuestionsView, ListHotQuestionsView, AskFormView, LoadMoreCommentsView, QuestionView, QuestionVoteView, SearchSuggestionView, SearchView, ListFoundQuestionsView
...
urlpatterns = [
    ...
    path('search/suggest/', SearchSuggestionView.as_view(), name='search_suggest'),
